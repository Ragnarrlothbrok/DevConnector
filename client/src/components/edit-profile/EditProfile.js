            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.handle}
                  info="A unique handle for your profile URL.Your full name,comapny name,nickname."
                />
                <SelectListGroup
                  placeholder="Status"
                  name="status"
                ...
                <TextFieldGroup
                  ...
                  info="Could be your own website or the one you work for."
                />
                <TextFieldGroup
                  ...
                  info="City or city & state suggested (eg. Mumbai,India)"
                />
                <TextFieldGroup
                  placeholder="* Skills"
                  name="skills"
                ...
                <TextAreaFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.bio}
                  info="Tell us a little about youself."
                />
                <div className="mb-3">
                  <button
                    type="button"
